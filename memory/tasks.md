...
- **Result**: Языковое предпочтение зафиксировано; продолжаю intake на русском. Пользователь ответил "?" — перехожу к максимально простому формату и задаю первый вопрос отдельно.
